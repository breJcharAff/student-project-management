...
function ProjectPageClient({ projectId }: ProjectPageClientProps) {
  ...
  const getTotalStudents = () => {
    return project.groups.reduce((total, group) => total + group.students.length, 0)
  }
          ...
          <div>
            ...
            <span className="flex items-center gap-1">
              ...
              <Target className="h-4 w-4" />
                {project.evaluationType} evaluation
            </span>
            </div>
          </div>
            ...
            <CardContent>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500">{project.defenseDurationInMinutes} minutes each</div>
                </div>
              </div>
            </CardContent>
          </Card>
                          ...
                          <div className="space-y-4">
                            ...
                            {group.reports.length > 0 && (
                                <div>
                                  ...
                                  <div className="text-sm text-slate-500">{group.reports.length} report(s) submitted</div>
                                </div>
                            )}
                          </div>
                        </CardContent>
              ...
              {project.promotions.map((promotion) => (
                  <Card key={promotion.id}>
                    <CardHeader>
                      ...
                      <CardDescription>{promotion.students.length} students</CardDescription>
                    </CardHeader>
                    <CardContent>
              ...
              <CardContent>
                <div className="space-y-3">
                  {project.groups
                      ...
                      .map((group) => (
                          <div key={group.id} className="flex items-center justify-between p-3 bg-slate-50 rounded-md">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <div className="text-sm text-slate-500">{group.students.map((s) => s.name).join(", ")}</div>
                              </div>
                            </div>
